...
export function TiktokIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden {...props}>
      <path d="M19.32 5.56a5.32 5.32 0 0 1-3.26-1.1 5.32 5.32 0 0 1-2.06-3.4V.5h-3.5v13.9a3.1 3.1 0 0 1-5.6 1.83 3.1 3.1 0 0 1 3.5-4.79V7.9a6.55 6.55 0 0 0-5.6 10.4A6.55 6.55 0 0 0 14 15.3V8.5a8.75 8.75 0 0 0 5.32 1.8V6.8c0-.42 0-.83 0-1.24z" />
    </svg>
  )
}
