    ...
    <section id="catalogue" className="py-16 sm:py-24 bg-background">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12">
          <div className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-3.5 py-1 text-xs font-semibold uppercase tracking-[0.16em] text-primary mb-3">
            {/* <Sparkles className="size-3.5 text-accent" /> */}
            <span>Catalogue Officiel 2026</span>
          </div>
          <h2 className="font-display text-2xl sm:text-4xl lg:text-5xl font-bold text-foreground tracking-tight">
            Les collections de la Casamance en mouvement
          </h2>
          <p className="mt-3 text-base text-muted-foreground leading-relaxed">
            Sélectionnez votre article officiel et commandez en un clic via WhatsApp avec livraison dans toute la Casamance et au Sénégal.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-10 pb-6 border-b border-border">
          ...
          <div className="relative w-full md:w-72">
            ...
            <input
              ...
              className="w-full rounded-full border border-input bg-card pl-10 pr-4 py-2.5 text-xs sm:text-sm text-foreground placeholder:text-muted-foreground focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 shadow-xs"
            />
          </div>
        </div>

        {/* Product Grid with Three.js Real 3D Images */}
        {filteredProducts.length > 0 ? (
          ...
          <div className="text-center py-16 rounded-3xl border border-dashed border-border bg-secondary/20 p-8">
            ...
            <button
              ...
              className="mt-4 inline-flex items-center gap-1.5 rounded-full bg-primary px-5 py-2.5 text-xs font-semibold text-white shadow-sm hover:bg-forest transition-colors cursor-pointer"
            >
