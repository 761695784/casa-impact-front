...
export function DocumentPreviewModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-6xl rounded-3xl p-6 flex max-h-[94vh] flex-col">
        <DialogHeader>
        ...
        <div className="flex min-h-[70vh] flex-1 items-center justify-center overflow-auto rounded-2xl border border-border bg-secondary/30">
          {isLoading && (
