...
interface PartenairesFilterBarProps {
  search: string
  statut: string
  type: string
...
export function PartenairesFilterBar({
  search,
  statut,
  type,
  onSearchChange,
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="relative flex-1 min-w-[240px]">
          ...
          <Input
            ...
            placeholder="Rechercher par nom d'organisation, email, description..."
