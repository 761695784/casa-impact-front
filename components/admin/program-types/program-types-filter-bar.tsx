...
interface ProgramTypesFilterBarProps {
  search: string
  statut: string
...
export function ProgramTypesFilterBar({
  search,
  statut,
  onSearchChange,
  onStatutChange,
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="relative flex-1 min-w-[240px]">
          ...
          <Input
            ...
            placeholder="Rechercher par nom de modalité, description..."
